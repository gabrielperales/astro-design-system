...
<div class="component-preview">
    <Button variant="secondary" size="sm">Primary button</Button>
    <Button variant="secondary" size="md">Primary button</Button>
    <Button variant="secondary" size="lg">Primary button</Button>
</div>
...
<div class="component-preview">
    <Button variant="outline" size="sm">Primary button</Button>
    <Button variant="outline" size="md">Primary button</Button>
    <Button variant="outline" size="lg">Primary button</Button>
</div>
